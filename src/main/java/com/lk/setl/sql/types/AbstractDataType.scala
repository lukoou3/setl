...
private[setl] object NumericType extends AbstractDataType {
  /**
  ...
  override private[setl] def defaultConcreteType: DataType = DoubleType

  override private[setl] def simpleString: String = "numeric"

  override private[setl] def acceptsType(other: DataType): Boolean =
