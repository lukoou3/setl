package com.lk.setl.sql.catalyst.plans

import scala.collection.mutable

import com.lk.setl.sql.catalyst.expressions._
import com.lk.setl.sql.catalyst.trees.{CurrentOrigin, TreeNode, TreeNodeTag}
...
abstract class QueryPlan[PlanType <: QueryPlan[PlanType]] extends TreeNode[PlanType]  {
  ...
  def verboseStringWithOperatorId(): String = {
    val argumentString = argString(25) /*SQLConf.get.maxToStringFields*/
