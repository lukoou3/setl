...
import com.lk.setl.sql.catalyst.expressions.{Attribute, Expression}
import com.lk.setl.sql.catalyst.plans.QueryPlan
import com.lk.setl.sql.catalyst.trees.CurrentOrigin
 ...
 * methods defined in [[com.lk.setl.sql.catalyst.trees.TreeNode]] and [[QueryPlan]].
 *
...
trait AnalysisHelper extends QueryPlan[LogicalPlan] { self: LogicalPlan =>
   ...
   * [[com.lk.setl.sql.catalyst.analysis.CheckAnalysis]].
   */
   ...
   * @see [[com.lk.setl.sql.catalyst.trees.TreeNode.transformDown()]].
   */
   ...
   * @see [[com.lk.setl.sql.catalyst.trees.TreeNode.transformUp()]]
   */
